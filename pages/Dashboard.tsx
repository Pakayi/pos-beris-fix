        ...
        <div className="bg-amber-100 border-l-4 border-amber-500 p-4 rounded-r-xl flex items-center justify-between shadow-sm">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-amber-700">Tersisa <b>{trialDaysLeft} hari</b> lagi. Hubungi kami untuk aktivasi permanen.</p>
            </div>
          </div>
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        <div>
          <div className="flex items-center gap-2 mb-1">
             ...
             <Badge color={profile.plan === 'pro' ? 'green' : 'blue'}>
               {profile.plan === 'pro' ? 'PRO PLAN' : trialDaysLeft !== null ? `TRIAL: ${trialDaysLeft} HARI` : 'FREE PLAN'}
             </Badge>
          </div>
          <p className="text-slate-500 text-sm">Selamat datang kembali, <b>{profile.displayName}</b></p>
        </div>
