...
const Reports: React.FC = () => {
  ...
  const stats = useMemo(() => {
    ...
    return { 
        totalRevenue, totalProfit, totalTransactions, avgTransaction, 
        topProducts, categoryData,
        totalAssetValue, totalPotentialRevenue, potentialProfit
    };
  }, [filteredTx, products]);
         ...
         <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
             <Card className="p-5 border border-amber-200 bg-amber-50">
                 <div className="flex items-center gap-3 mb-2">
                     <div className="p-2 bg-amber-200 rounded text-amber-700"><i className="fa-solid fa-coins"></i></div>
             ...
             <Card className="p-5 border border-blue-200 bg-blue-50">
                 <div className="flex items-center gap-3 mb-2">
                     <div className="p-2 bg-blue-200 rounded text-blue-700"><i className="fa-solid fa-tags"></i></div>
             ...
             <Card className="p-5 border border-emerald-200 bg-emerald-50">
                 <div className="flex items-center gap-3 mb-2">
                     <div className="p-2 bg-emerald-200 rounded text-emerald-700"><i className="fa-solid fa-piggy-bank"></i></div>
                  ...
                  <tr key={i} className="hover:bg-gray-50">
                    <td className="px-4 py-3 font-medium text-gray-800">
                      <div className="flex items-center gap-3">
                        <span className={`w-6 h-6 rounded-full flex items-center justify-center text-xs text-white font-bold ${i < 3 ? 'bg-amber-400' : 'bg-gray-300'}`}>
                          {i + 1}
                        </span>
                        {p.name}
                      </div>
          ...
          <div className="overflow-x-auto">
            <table className="w-full text-sm">
              ...
              <tbody className="divide-y divide-gray-100">
                  ...
                  <tr key={t.id} className="hover:bg-gray-50">
                    <td className="px-4 py-3 text-gray-600">
                      ...
                      <span className="text-[10px] text-gray-400">
                        {new Date(t.timestamp).toLocaleDateString('id-ID', { day: 'numeric', month: 'short' })}
                      </span>
                    </td>
                ...
                {filteredTx.length === 0 && (
                  <tr><td colSpan={3} className="text-center py-6 text-gray-400">Belum ada transaksi</td></tr>
                )}
              </tbody>
            </table>
          </div>
