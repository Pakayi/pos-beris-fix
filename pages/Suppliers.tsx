  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        ...
        <Button onClick={() => { setEditingSupplier({ category: 'Umum' }); setIsModalOpen(true); }} icon="fa-plus">
          Tambah Supplier
        </Button>
      </div>
        ...
        <div className="overflow-x-auto">
          <table className="w-full text-sm text-left">
            ...
            <tbody className="divide-y divide-gray-100">
                ...
                <tr key={s.id} className="hover:bg-gray-50 transition-colors">
                  ...
                  <td className="px-4 py-3 text-center">
                    <div className="flex justify-center gap-2">
                      <button onClick={() => { setEditingSupplier(s); setIsModalOpen(true); }} className="p-2 text-blue-600 hover:bg-blue-50 rounded">
              ...
              {filtered.length === 0 && (
                <tr><td colSpan={5} className="p-8 text-center text-gray-400 italic">Belum ada data supplier</td></tr>
              )}
            </tbody>
          </table>
        </div>
